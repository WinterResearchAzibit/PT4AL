...
trainset = torchvision.datasets.Caltech256(root='./data', train=True, download=True, transform=None)

testset = torchvision.datasets.Caltech256(root='./data', train=False, download=True, transform=None)
